// Reused on every medical screen when useFeatureFlag('medical_records') is off.
// Renders the lock state + a logout button (uses ConfirmSheet — never confirmAlert).
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.body}>
        ...
        >
          <Ionicons name="log-out-outline" size={18} color={tokens.color.m600} />
